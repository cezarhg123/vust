...
fn model_rect() {
    ...
    while !window.should_close() {
        ...
        vust.update_descriptor_set(&descriptor, &[WriteDescriptorInfo::Image { image_view: texture.view(), sampler: texture.sampler() }, WriteDescriptorInfo::Buffer { buffer: model_uniform_buffer.handle(), offset: 0, range: size_of::<glm::Mat4>() as u64 }]);
